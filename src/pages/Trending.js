...
const Trending = () => {
  ...
  // Fetch trending recipes (sorted by viewCount)
  const { data: trendingRecipes = [], isLoading } = useQuery({
    queryKey: ['trendingRecipes'],
    queryFn: async () => {
      const recipesRef = collection(db, 'recipes');
      const q = query(recipesRef, orderBy('viewCount', 'desc'), limit(12));
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-600 max-w-2xl mx-auto mb-8">
              Discover the most popular recipes loved by our community. These recipes are trending based on views and engagement.
            </p>
